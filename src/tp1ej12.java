...
public class  tp1ej12 {
    public static void main(String[] args) {
        ...
        switch (dia) {
            case 1:
                System.out.println("El dia 1 es lunes,dia laboral");
                break;
            case 2:
                System.out.println("El dia 2 es martes,dia laboral");
                break;
            case 3:
                System.out.println("El dia 3 es miercoles,dia laboral");
                break;
            case 4:
